...
export async function getStudentProfileApi() {
  try {
    ...
    const response = await fetch(`${IDENTITY_API_BASE_URL}/student/profile`, {
      method: 'GET',
      headers,
    });
...
export async function registerStudentProfileApi(profileData) {
  try {
    ...
    const response = await fetch(`${IDENTITY_API_BASE_URL}/student/profile/register`, {
      method: 'POST',
      headers,
...
export async function getActiveStudentProfilesApi() {
  try {
    ...
    const response = await fetch(`${IDENTITY_API_BASE_URL}/student/profile/active`, {
      method: 'GET',
      headers,
    });
    const resData = await response.json().catch(() => ({}));
...
export async function activateStudentProfileApi() {
  try {
    ...
    const response = await fetch(`${IDENTITY_API_BASE_URL}/student/profile/activate`, {
      method: 'POST',
      headers,
    });
    const resData = await response.json().catch(() => ({}));
...
/**
 * Deactivate student profile (set Inactive)
 * @returns {Promise<object>}
 */
export async function deactivateStudentProfileApi() {
  try {
    ...
    const response = await fetch(`${IDENTITY_API_BASE_URL}/student/profile/deactivate`, {
      method: 'POST',
      headers,
    });
    const resData = await response.json().catch(() => ({}));
