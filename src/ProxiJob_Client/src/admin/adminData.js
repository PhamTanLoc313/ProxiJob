...
export const mockSubscriptions = [
  ...
  },
  {
    id: 2,
    name: "Recruit",
    description: "Dành cho cửa hàng cần tuyển dụng",
    price: 99000,
    variableCost: 30000,
    grossMargin: 69000,
    billingType: "Monthly",
    ...
    activeUsers: 1,
    features: [
      "Đăng tuyển 30 tin/tháng",
      "Bán kính quét tin 7 km",
      "Quản lý ứng viên qua CV",
    ],
  },
  {
    id: 3,
    name: "HRM Basic",
    description: "Tuyển dụng & Quản lý nhân sự",
    price: 199000,
    variableCost: 50000,
    grossMargin: 149000,
    billingType: "Monthly",
    ...
    activeUsers: 1,
    features: [
      "Đăng tuyển 60 tin/tháng",
      "Quản lý tối đa 15 nhân viên",
      "Kích hoạt 1 mã QR chấm công",
      "Bán kính quét tin 10 km",
    ],
  },
  {
    id: 4,
    ...
    activeUsers: 0,
    features: [
      "Đăng tuyển không giới hạn tin",
      "Quản lý nhân sự không giới hạn",
      "Không giới hạn mã QR chấm công",
      "Bán kính quét tin không giới hạn",
    ],
  },
];
...
export const mockActivities = [
  { id: 1, type: "payment", message: "Trần Minh Khôi tạo đơn thanh toán gói HRM Cơ bản", time: "2026-06-28T14:30:00Z" },
  ...
  { id: 4, type: "payment", message: "Hoàng Đức Trung tạo đơn thanh toán gói Tuyển dụng", time: "2026-06-29T09:15:00Z" },
